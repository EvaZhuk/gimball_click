...
QT_MOC_LITERAL(6, 40, 5), // "start"
QT_MOC_LITERAL(7, 46, 4), // "stop"
QT_MOC_LITERAL(8, 51, 10), // "setRtspUrl"
QT_MOC_LITERAL(9, 62, 3) // "url"

    },
    "VideoWorker\0frameReady\0\0img\0status\0"
    "text\0start\0stop\0setRtspUrl\0url"
};
...
void VideoWorker::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 4: _t->setRtspUrl((*reinterpret_cast< const QString(*)>(_a[1]))); break;
        default: ;
        }
        ...
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&VideoWorker::status)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 1
void VideoWorker::status(const QString & _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t1))) };
